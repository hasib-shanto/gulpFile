...
// 0. npm install gulp -g (when doesn't open gulp for single command)
// 1. npm init
// 2. npm install bootstrap jquery popper.js font-awesome --save
// 3. npm install gulp browser-sync gulp-sass --save-dev
// 4. gulp
// 5. npm start (for next time when project start again)
// 6. code .  (open vs code with command line)
